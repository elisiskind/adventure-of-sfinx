...
export const IntroMessage: Message = {
    ...
    the other side of the GDZ, far away from the space police.`,
        <>
            <div>Scan this to access the wormhole coordinator drive:</div>
            <div style={{textAlign: "center"}}>
            <img width={128} height={128} src={'/img/qr-code-1.png'} alt={'QR code for https://adventure-of-sfinx.web.app/9KZ8'}/>
            </div>
        </>
    ],
