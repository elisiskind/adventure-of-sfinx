...
export const GeigerCounter = () => {
  ...
  return (<>
    ...
    <Beep on={level > 0} detect={detectRadiation} key='0' audio={audio1 as HTMLAudioElement}/>
    <Beep on={level > 1} detect={detectRadiation} key='1' audio={audio2 as HTMLAudioElement}/>
    <Beep on={level > 2} detect={detectRadiation} key='2' audio={audio3 as HTMLAudioElement}/>
  </>);
}
