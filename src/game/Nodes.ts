...
export type NodeId = keyof typeof GameNode | keyof typeof FailureNodes;
...
export const gameGraph = ():TextNodeGraph => {
  return {
    ...
    THANKS_1: {
      prompt: 'Ship: "Well, of course! Who wants a space ship that doesn\'t even welcome you aboard! Now, where are we ' +
          'off to today?"',
      options: {
